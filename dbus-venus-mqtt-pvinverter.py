...
class DbusVenusMQTTService:
  def __init__(self, servicename, paths, productname='PV inverter on output', connection='Venus MQTT service'):
...
def main():
  ...
  try:
      ...
      pvac_output = DbusVenusMQTTService(
